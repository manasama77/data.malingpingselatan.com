...
(warga_id, tanggal_pembuatan, kepentingan, tujuan, nomor_surat, sequence, nama_ttd, jabatan_ttd, nomor_induk_ttd)
VALUES
($warga_id, '$tanggal_pembuatan', '$kepentingan', '$tujuan', '$nomor_surat', $sequence, '$nama_ttd', '$jabatan_ttd', '$nomor_induk_ttd')
";
$query = mysqli_query($db, $sql);
...
if ($query) {
    ...
    logs($warga_id, "Surat Pengantar", $nomor_surat, 'surat_pengantar', $id);
}
