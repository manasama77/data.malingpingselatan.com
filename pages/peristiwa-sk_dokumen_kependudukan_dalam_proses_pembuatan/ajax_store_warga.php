...
$sql = "
INSERT INTO `sk_dokumen_kependudukan_dalam_proses_pembuatan` 
(
    warga_id,
    tanggal_pembuatan,
    nomor_surat,
...
if ($query) {
    ...
    logs($warga_id, "Surat Keterangan Dokumen Kependudukan Dalam Proses Pembuatan", $nomor_surat, 'sk_dokumen_kependudukan_dalam_proses_pembuatan', $id);
}
