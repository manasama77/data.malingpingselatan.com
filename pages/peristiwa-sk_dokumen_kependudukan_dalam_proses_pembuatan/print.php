...
$sql = "
SELECT
    sk_dokumen_kependudukan_dalam_proses_pembuatan.warga_id,
    sk_dokumen_kependudukan_dalam_proses_pembuatan.tanggal_pembuatan,
    sk_dokumen_kependudukan_dalam_proses_pembuatan.nomor_surat,
    sk_dokumen_kependudukan_dalam_proses_pembuatan.jenis_pembuatan,
    sk_dokumen_kependudukan_dalam_proses_pembuatan.nama_kepala_desa,
    sk_dokumen_kependudukan_dalam_proses_pembuatan.nrp,
    warga.nama_warga,
    warga.nik_warga,
...
WHERE
    sk_dokumen_kependudukan_dalam_proses_pembuatan.id = " . $id . "
";
            ...
            <div class="col-12">
                ...
                <table class="table table-borderless table-condensed table-sm w-100 p-0">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3">Nama tersebut yang tercantum diatas adalah benar penduduk desa kami serta terdaftar di Buku Induk Penduduk (BIP) dan yang bersangkutan benar telah melakukan Permohonan pembuatan : <b><?= $row_warga['jenis_pembuatan']; ?></b>, dan Dokumen Kependudukan tersebut masih dalam proses pembuatan di Dinas Kependudukan dan Pencatatan Sipil <?= KOKAB; ?>. </td>
                        </tr>
                        <tr>
                            <td colspan="3">Demikian keterangan ini dibuat dan diberikan atas dasar yang sebenarnya dan kepada yang berkepentingan agar dipergunakan seperlunya.</td>
                        </tr>
                        <tr>
                            <td colspan="3"><br /></td>
                        </tr>
