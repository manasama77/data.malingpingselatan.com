...
WHERE sk_tidak_memiliki_hubungan_keluarga.id = " . $_GET['id'] . "
";
...
<div class="row page-header">
    <div class="col-sm-12 col-md-9">
        <h4>
            Edit Data Surat Keterangan Tidak Memiliki Hubungan Keluarga
        </h4>
    </div>
...
<div class="row">
    <form id="form">
        <div class="col-sm-12 col-md-6 col-md-offset-3">
            ...
            <div class="form-group">
                <label for="kerabat_id">Kerabat <span class="text-danger">*</span></label>
                <select class="form-control select2" id="kerabat_id" name="kerabat_id" data-placeholder="Cari Kerabat" required>
                    <option value=""></option>
                    <option value="<?= $row['kerabat_id']; ?>" selected="selected"><?= $row['nama_kerabat']; ?></option>
                </select>
            </div>
            <div class=" form-group">
