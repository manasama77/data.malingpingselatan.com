...
<form action="store.php" method="post">
  ...
  <!--
    <div class="form-group">
      ...
      <div class="col-md-9">
        <div class="radio">
          <?php # echo form_radio('is_kembar', 'Y', FALSE); 
          ?><label class="radio"><input type="radio" name="is_kembar" value="Y"> Ya</label>
        </div>
        <div class="radio">
          <?php # echo form_radio('is_kembar', 'N', TRUE); 
      ...
      <span class="help-block">
        <select class="form-control selectlive" name="nama_kepala_keluarga" id="isian" required>
          ...
          <?php foreach ($data_keluarga as $keluarga) : ?>
            <option value="<?php echo $keluarga['nomor_keluarga'] ?>" no_kk="<?php echo $keluarga['nomor_keluarga'] ?>" alamat_kk="<?php echo $keluarga['alamat_keluarga'] ?>" id_keluarga="<?php echo $keluarga['id_keluarga'] ?>" nm_kk="<?php echo $keluarga['nama_warga'] ?>" desa_kk="<?php echo $keluarga['desa_kelurahan_warga'] ?>" dusun_kk="<?php echo $keluarga['dusun_warga'] ?>" rt_kk="<?php echo $keluarga['rt_warga'] ?>" rw_kk="<?php echo $keluarga['rw_warga'] ?>">
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
      <div class="form-group">
        ...
        ?>
    <span class="help-block"><?php #echo form_error('id_perangkat', '<p class="field_error">','</p>')
                              ?> </span> 
    </div>  
  </div>
-->
