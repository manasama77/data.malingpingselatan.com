...
$sql = "
SELECT
	belum_mempunyai_rumah.nomor_surat,
	belum_mempunyai_rumah.tanggal_pembuatan,
	warga.nama_warga,
	warga.nik_warga,
    ...
    belum_mempunyai_rumah.nama_ttd,
	belum_mempunyai_rumah.jabatan_ttd,
	belum_mempunyai_rumah.nomor_induk_ttd
FROM
	belum_mempunyai_rumah
	LEFT JOIN warga ON warga.id_warga = belum_mempunyai_rumah.warga_id 
WHERE
	belum_mempunyai_rumah.id = " . $id . "
";
