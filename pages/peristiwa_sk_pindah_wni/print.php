...
$sql_kayu   = "SELECT * FROM sk_pergi_wni_warga WHERE sk_pergi_wni_id = '" . $row_warga['id'] . "'";
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <table class="table table-borderless table-condensed table-sm w-100 p-0" style="font-size: 0.9rem; line-height: 0.8;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 250px;">Rencana Tanggal Pindah</td>
                            <td style="width: 5px;">:</td>
                            <td>
                                <?= tanggal_indo_no_dash($row_warga['tanggal_kepindahan']); ?>
                            </td>
                            <td colspan="4" style="width: 200px;">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="8">
                                <table class="table table-bordered table-condensed table-sm w-100 p-0" style="font-size: 0.9rem; line-height: 0.8;">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql_sub = "SELECT * FROM sk_pergi_wni_warga WHERE sk_pergi_wni_id = '" . $row_warga['id'] . "'";
