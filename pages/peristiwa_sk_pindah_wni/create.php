...
<form id="form">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
            <div class="form-group">
                <label for="tanggal_kepindahan">Tanggal Kepindahan <span class="text-danger">*</span></label>
                <input type="date" class="form-control" id="tanggal_kepindahan" name="tanggal_kepindahan" placeholder="Tanggal Kepindahan" required />
            </div>
            <div class="form-group">
